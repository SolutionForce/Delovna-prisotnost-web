...
const ChartTwo: React.FC = () => {
  ...
  return (
    <div className="relative z-0 col-span-12 rounded-sm border border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      ...
      <div>
        <div id="chartTwo" className="relative z-0">
          <ReactApexChart
            options={options}
            series={state.series}
            type="bar"
